...
$string['exams'] = "Hauptseite (Klausurenliste)";
$string['exam_groups'] = "Vorhandene Klausuren:";
$string['open_question_bank'] = "Fragensammlung öffnen";
$string['goto_wizzard'] = "Assistent starten";
$string['goto_category'] = "Kategorieverwaltung";
$string['goto_other'] = "Weitere Optionen";
$string['goto_import'] = "Fragenpool importieren";
$string['goto_export'] = "Fragenpool exportieren";
$string['back_to_mainsite'] = "Zurück zur Hauptseite";
$string['create_exam_group'] = "Neue Klausur";

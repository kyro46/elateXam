...
class question_category_edit_form extends moodleform {
    ...
    protected function definition() {
        ...
        $mform->setDefault('name', 'Neue Kategorie');
        ...
        $mform->addElement('hidden', 'info', get_string('categoryinfo', 'question'), array('rows'=> '10', 'cols'=>'45'));
...
class question_category_edit_form_param extends moodleform {

...
require_once($CFG->dirroot."/question/wizzard_class.php");
...
list($thispageurl, $contexts, $cmid, $cm, $module, $pagevars) =
        question_edit_setup('categories', '/question/wizzard.php');
...
?>
	<br>
	<br>
    <a href="<?php echo $CFG->wwwroot ?>/course/view.php?id=<?php echo   htmlspecialchars($_GET["courseid"]); ?>"><button><?php echo get_string('back_to_mainsite', 'format_elatexam') ?></button></a>
<?PHP	
}
echo $OUTPUT->footer();
?>
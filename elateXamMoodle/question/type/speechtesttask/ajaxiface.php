...
require_once($CFG->dirroot . '/question/type/speechtesttask/questiontype.php');
require_once($CFG->dirroot . '/question/type/speechtesttask/edit_speechtesttask_form.php');

// TestURL: http://localhost/moodle23/question/type/speechtesttask/ajaxiface.php?json_request_for_subquestion=1
...
$speechtestobj = new qtype_speechtesttask();
if($qid) {
	$question = $DB->get_record('question', array('id' => $qid));
	$speechtestobj->get_question_options($question);
} else {
	$question = new stdClass();
	$question->category = $categoryid;
	$question->qtype = $speechtestobj->name();
...
$formobj = new qtype_speechtesttask_edit_form("", $question, $category, $contexts);

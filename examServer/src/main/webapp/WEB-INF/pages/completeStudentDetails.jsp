...
<content tag="heading">
<fmt:message key="common.hello" /> <authz:authentication
	operation="fullName" />!</content>
<meta name="menu" content="MainMenu" />
</head>
<p>
	<fmt:message key="mainMenu.complete.data" />
	<br>
	<html:form action="/submitStudentsInfo" styleId="userForm"
			...
			<li>
				<div>
					<div class="left">
						...
						<html:text styleClass="text medium" property="matrikel"
							styleId="matrikel" />
					</div>
					<div>
						<examServer:label styleClass="desc" key="userForm.semester" />
						<html:errors property="semester" />
						<html:text styleClass="text medium" property="semester"
							styleId="semester" />
					</div>
				</div>
			</li>
